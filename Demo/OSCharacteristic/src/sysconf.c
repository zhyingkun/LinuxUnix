...
int sysConfInt[] = {_SC_ARG_MAX,        _SC_ATEXIT_MAX,    _SC_CHILD_MAX,     _SC_CLK_TCK,      _SC_COLL_WEIGHTS_MAX,
                    _SC_DELAYTIMER_MAX, _SC_HOST_NAME_MAX, _SC_IOV_MAX,       _SC_LINE_MAX,     _SC_LOGIN_NAME_MAX,
                    _SC_NGROUPS_MAX,    _SC_OPEN_MAX,      _SC_PAGESIZE,      _SC_PAGE_SIZE,    _SC_RE_DUP_MAX,
                    _SC_RTSIG_MAX,      _SC_SEM_NSEMS_MAX, _SC_SEM_VALUE_MAX, _SC_SIGQUEUE_MAX, _SC_STREAM_MAX,
                    _SC_SYMLOOP_MAX,    _SC_TIMER_MAX,     _SC_TTY_NAME_MAX,  _SC_TZNAME_MAX};

char* sysConfName[] = {"Exec func max arg length",
...
int pathConfInt[] = {_PC_FILESIZEBITS,
                     _PC_LINK_MAX,
                     _PC_MAX_CANON,
                     _PC_MAX_INPUT,
                     _PC_NAME_MAX,
...
char* pathConfName[] = {"FILESIZEBITS",
                        "LINK_MAX",
                        "MAX_CANON",
                        "MAX_INPUT",
