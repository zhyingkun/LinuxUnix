...
main(int argc, char *argv[])
{
    ...
    for (cmsgp = CMSG_FIRSTHDR(&msgh);
        ...
        case SCM_RIGHTS:        /* Header containing file descriptors */
            ...
            /* The number of file descriptors is the size of the
               control message block minus the size of the control message
               header, divided by the size of a file descriptor */

            fdCnt = (cmsgp->cmsg_len - sizeof(struct cmsghdr)) / sizeof(int);
